...
1. `CONTRIBUTING.md`、`AGENTS.md`、`AGENTS.md`、`.github/pull_request_template.md`
...
若仓库有 `.Codex/skills/pr-commit/` 或 `CONTRIBUTING.md` 中的 scope 表，**以项目内文件为准**，可覆盖本文 scope 与 subject 语言。
