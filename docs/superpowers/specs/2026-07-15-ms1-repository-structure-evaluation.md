...
- [`learn-1024xengineer/02-product-first.md`](../../../learn-1024xengineer/02-product-first.md)：PRD、系统架构、协议/数据设计和实现应保持决策层次。
- [`learn-1024xengineer/03-ai-dev-guidelines.md`](../../../learn-1024xengineer/03-ai-dev-guidelines.md)：最少代码、目标驱动验证、不提前建设推测性抽象。
- [`learn-1024xengineer/04-multi-client-design.md`](../../../learn-1024xengineer/04-multi-client-design.md)：客户端通过统一协议接入核心系统，不建立平行业务逻辑。
- [`learn-1024xengineer/05-task-centric.md`](../../../learn-1024xengineer/05-task-centric.md)：面试应建模为可恢复的任务状态，而不是只有聊天消息列表。
- [`learn-1024xengineer/06-engineering-closure.md`](../../../learn-1024xengineer/06-engineering-closure.md)：主链路需要可复现 Demo、自动验证和 CI 证据。
